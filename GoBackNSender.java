...
class GoBackNSender {
	...
	public GoBackNSender(String host, int port) {
	    ...
	    try {
		    ...
		    GoBackNPacket gbnPacket = new GoBackNPacket(GoBackNPacket.TYPE_HELLO, (byte)0, 'h');
		    DatagramPacket dgPacket = gbnPacket.toDatagramPacket();
		    dgPacket.setAddress(receiverAddress);
		    dgPacket.setPort(receiverPort);
